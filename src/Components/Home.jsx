        ...
        <main className='xl:px-0 lg:px-32 md:px-16 px-4'>
            <section className=' bg-white' id='about-us'>
                <div className='flex justify-between w-full max-w-7xl xl:gap-20 gap-10 xl:flex-row flex-col items-center'>
                    <div className='xl:w-7/12 w-full'>
                        ...
                        <p className=' '>
                            Hartcliffe Coderz is a small but diverse resident-led team. We believe
                ...
                <div className='flex justify-between w-max max-w-7xl items-center xl:gap-16 gap-10 xl:flex-row flex-col-reverse'>
                    ...
                    <div className='xl:w-7/12 w-full '>
                        ...
                        <p className=''>
                            ...
                            prior experience. We supply all the necessary equipment and software, so
                            all you need to bring is your curiosity and enthusiasm to learn and make
                            new friends. Refreshments are provided, making it a welcoming and
            ...
            <section className='bg-white justify-center align-middle' id='summer-camps'>
                <div className='flex justify-between w-full max-w-7xl align-middle xl:gap-16 gap-10 xl:flex-row flex-col '>
                    <div className='xl:w-7/12 w-full '>
                        <h1 className='text-slate-600 xl:text-left text-center '>Summer Camp</h1>
                        <p className=''>
                        ...
                        <button
                            id='newsButton'
                            className='border-[1px] border-zinc-600 px-10 py-4 my-6 rounded-full uppercase font-semibold hover:bg-gradient-to-r background-animate from-lime-200 to-amber-200 transition-all hover:border-white  text-slate-600  ring-lime-500/30 focus:bg-white focus:outline-none focus:ring-4 mx-auto'
                        >
