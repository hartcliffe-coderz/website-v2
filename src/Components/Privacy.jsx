    ...
    return (
        <div className='policy max-w-3xl mx-auto'>
            ...
            <ul>
                ...
                <li>
                    <p>
                        ...
                        to Hartcliffe Coderz CIC, 40 Vicarage Road, Bristol BS3 1PD.
                    </p>
                </li>
                <li>
                    <p>
                ...
                <li>
                    <p>
                        ...
                        to the Service or to assist the Company in analysing how the Service is
                        used.
                    </p>
                </li>
                <li>
                ...
                <li>
                    <p>
                        <strong>Website</strong> refers to Hartcliffe Coderz, accessible from{' '}
                        <a
                            href='https://hartcliffe.coderz.uk'
                            rel='external nofollow noopener'
                            target='_blank'
                        >
                            https://hartcliffe.coderz.uk
                        </a>
                    </p>
                </li>
                <li>
            ...
            <ul>
                ...
                <li>
                    <p>Address, Province, Post code, City</p>
                </li>
                <li>
                    <p>Usage Data</p>
                </li>
